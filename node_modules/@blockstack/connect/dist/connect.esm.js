...
import { Box, Flex, Text, Spinner, ChevronIcon, PseudoBox, Button, Stack, ThemeProvider, theme, ScopedCSSReset, Modal as Modal$1 } from '@blockstack/ui';
...
var Link = function Link(_ref) {
  var _ref$_hover = _ref._hover,
      ...
      rest = _objectWithoutPropertiesLoose(_ref, ["_hover", "children", "textStyle"]);

  return React.createElement(Box, Object.assign({}, rest), React.createElement(Text, {
    _hover: _extends({
...
var HeaderTitle = function HeaderTitle(_ref) {
  ...
  return React.createElement(Flex, {
    align: "center"
  }, hideLogo ? null : React.createElement(Logo, {
    mr: 2
...
var ScreenHeader = function ScreenHeader(_ref2) {
  var appDetails = _ref2.appDetails,
      _ref2$title = _ref2.title,
      title = _ref2$title === void 0 ? 'Secret Key' : _ref2$title,
      ...
      rest = _objectWithoutPropertiesLoose(_ref2, ["appDetails", "title", "hideIcon", "hideLogo"]);
  ...
  return React.createElement(Flex, Object.assign({
    ...
    align: "center"
  }, !hideIcon ? React.createElement(AppIcon, {
    src: appIcon,
    alt: appName || 'loading'
  }) : null, !hideIcon ? React.createElement(Box, {
    mx: 1,
    color: "ink.300"
  }, React.createElement(ChevronIcon, {
    direction: "right"
  })) : null, React.createElement(HeaderTitle, {
    hideLogo: hideLogo,
    title: title
  })));
};
...
var PoweredBy = function PoweredBy() {
  return React.createElement(Flex, {
    ...
    onClick: function onClick() {
      return typeof window !== 'undefined' && window.open('https://blockstack.org', '_blank');
    },
    textStyle: "caption",
    display: "flex",
    alignSelf: "flex-end",
...
if (typeof window !== 'undefined') {
  ...
  window.__useScrollLockInstances = window.__useScrollLockInstances ||
  /*#__PURE__*/
  new Set();
...
var HeaderTitle$1 = function HeaderTitle(_ref2) {
...
var ModalHeader = function ModalHeader(_ref4) {
  ...
  }, React.createElement(HeaderTitle$1, {
    hideIcon: hideIcon,
    title: title
...
export { Connect, PoweredBy, Screen, ScreenActions, ScreenBody, ScreenFooter, ScreenHeader, ScreenLoader, Title, authenticate, popupCenter, showBlockstackConnect, useConnect };
