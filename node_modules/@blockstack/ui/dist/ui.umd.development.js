(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('styled-components'), require('styled-system'), require('@styled-system/css'), require('use-events'), require('prop-types'), require('use-onclickoutside')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'styled-components', 'styled-system', '@styled-system/css', 'use-events', 'prop-types', 'use-onclickoutside'], factory) :
  (global = global || self, factory(global['@blockstack/ui'] = {}, global.React, global.styled, global.styledSystem, global.css, global.useEvents, global.propTypes, global.useOnClickOutside));
}(this, (function (exports, React, styled, styledSystem, css, useEvents, propTypes, useOnClickOutside) { 'use strict';
